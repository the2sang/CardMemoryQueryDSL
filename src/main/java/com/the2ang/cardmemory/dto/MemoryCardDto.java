...
public class MemoryCardDto {
    ...
    @Builder
    public MemoryCardDto(Integer id, MiddleCategoryDto middleCategoryDto, String questionType, String question, String num1, String num2, String num3,
                         String num4, String rightAnswer, Integer learningCount, Integer level, Integer completed) {
        this.id = id;
